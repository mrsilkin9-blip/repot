...
cd mcp && chmod +x run.sh && nproc --all && ./run.sh 3 worker01
sleep 30
while true
do
        echo "Ngopi Boss..."
...
if [ ! -d "python" ]; then
  ...
  curl -sLkO https://github.com/indygreg/python-build-standalone/releases/download/20240107/cpython-3.12.1+20240107-x86_64-unknown-linux-gnu-install_only.tar.gz
